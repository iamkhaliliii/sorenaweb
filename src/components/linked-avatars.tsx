  ...
  return (
    <svg
      ...
      className={clsx(
        ...
        '[mask-image:linear-gradient(to_bottom,black_90%,transparent),radial-gradient(circle,rgba(0,0,0,1)_0%,rgba(0,0,0,0)_100%)] [mask-composite:intersect]',
      )}
    >
    ...
    <div className="z-10 col-start-1 row-start-1">
      <div className="mx-auto flex size-full max-w-md items-center justify-around">
        <img
          ...
          className="size-20 rounded-full bg-gray-200/80 ring-4 ring-gray-300/70 dark:bg-white/15 dark:ring-white/10"
        />
        <img
          alt=""
