...
const features: Array<Feature> = [
  {
    name: 'Listen & Organize',
    summary: 'Centralize every voice of customer signal.',
    description:
      'Sorena listens across 30+ tools—from Intercom to Slack to G2—and turns scattered feedback into structured data.',
...
function Feature({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-[300px] text-sm/4 text-gray-600 group-data-dark:text-gray-400">
        {feature.summary}
      </p>
      <h3
        className={clsx(
          'mt-1 text-2xl/8 font-semibold tracking-tight text-gray-950',
      ...
      <p className="mt-2 max-w-[400px] text-sm/4 text-gray-600 group-data-dark:text-gray-400">
        {feature.description}
      </p>
    </div>
  )
    ...
    <TabGroup className="hidden lg:mt-20 lg:block">
      {({ selectedIndex }) => (
        <>
          ...
          <TabPanels className="relative mt-20 overflow-hidden rounded-4xl bg-[linear-gradient(to_top,#dad4ec_0%,#dad4ec_1%,#f3e7e9_100%)] px-14 py-16 xl:px-16">
